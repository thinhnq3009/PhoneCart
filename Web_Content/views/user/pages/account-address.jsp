    ...
    <div class="container px-0 px-md-3">
      ...
      <div class="offcanvas offcanvas-start p-4 p-lg-0" id="navbar-default">
        ...
        <div class="d-flex justify-content-between align-items-center mb-2 d-block d-lg-none">
          <a href="../index.html"><img src="${pageContext.request.contextPath}/Assets/assets/images/logo/freshcart-logo.svg"
                ...
                <div class="row p-2 p-lg-4">
                  ...
                  <div class="col-lg-3 col-12 mb-4 mb-lg-0">
                    <div class="card border-0">
                      <img src="${pageContext.request.contextPath}/Assets/assets/images/banner/menu-banner.jpg" alt="eCommerce HTML Template"
...
<footer class="footer">
  <div class="container">
        ...
        <div class="col-lg-5 text-lg-start text-center mb-2 mb-lg-0">
          <ul class="list-inline mb-0">
            ...
            <li class="list-inline-item">
              <a href="#!"><img src="${pageContext.request.contextPath}/Assets/assets/images/payment/amazonpay.svg" alt=""></a>
            </li>
            <li class="list-inline-item">
              <a href="#!"><img src="${pageContext.request.contextPath}/Assets/assets/images/payment/american-express.svg" alt=""></a>
            </li>
            <li class="list-inline-item">
              <a href="#!"><img src="${pageContext.request.contextPath}/Assets/assets/images/payment//mastercard.svg" alt=""></a>
            </li>
            <li class="list-inline-item">
              <a href="#!"><img src="${pageContext.request.contextPath}/Assets/assets/images/payment/paypal.svg" alt=""></a>
            </li>
            <li class="list-inline-item">
              <a href="#!"><img src="${pageContext.request.contextPath}/Assets/assets/images/payment/visa.svg" alt=""></a>
            </li>
          </ul>
        </div>
        <div class="col-lg-7 mt-4 mt-md-0">
          <ul class="list-inline mb-0 text-lg-end text-center">
            ...
            <li class="list-inline-item ms-4">
              <a href="#!"> <img src="${pageContext.request.contextPath}/Assets/assets/images/appbutton/appstore-btn.svg" alt=""
                  style="width: 140px;"></a></li>
            <li class="list-inline-item">
              <a href="#!"> <img src="${pageContext.request.contextPath}/Assets/assets/images/appbutton/googleplay-btn.svg" alt=""
                  style="width: 140px;"></a></li>
          </ul>
        </div>
      </div>
    ...
    <div class="border-top py-4">
      <div class="row align-items-center">
        <div class="col-md-6"><span class="small text-muted">Copyright 2022 Â© FreshCart eCommerce HTML Template.  All rights reserved. Powered by <a href="https://codescandy.com/">Codescandy</a>.</span></div>
        <div class="col-md-6">
